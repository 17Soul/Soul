package com.google.soul.widget.ratingbar;
...
public class RatingBar extends View {
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        starSize = array.getDimensionPixelOffset(R.styleable.RatingBar_starSize, DEFAULT_STAR_SIZE);
        starCount = array.getInteger(R.styleable.RatingBar_starCount, DEFAULT_STAR_COUNT);
        starSpace = array.getDimensionPixelOffset(R.styleable.RatingBar_starSpace, DEFAULT_STAR_SPACE);
        starStrokeWidth = array.getDimensionPixelOffset(R.styleable.RatingBar_starStrokeWidth,
                DEFAULT_STAR_STROKE_WIDTH);
        showStroke = array.getBoolean(R.styleable.RatingBar_starShowStroke, DEFAULT_STAR_SHOW_STROKE);
        starStrokeColor = array.getColor(R.styleable.RatingBar_starStrokeColor, DEFAULT_STAR_STROKE_COLOR);
        starFillColor = array.getColor(R.styleable.RatingBar_starFillColor, DEFAULT_STAR_FILL_COLOR);
        starCoverColor = array.getColor(R.styleable.RatingBar_starCoverColor, DEFAULT_STAR_COVER_COLOR);
        starMaxProgress = array.getFloat(R.styleable.RatingBar_starMaxProgress, DEFAULT_STAR_MAX_PROGRESS);
        starProgress = array.getFloat(R.styleable.RatingBar_starProgress, DEFAULT_STAR_PROGRESS);
        useGradient = array.getBoolean(R.styleable.RatingBar_starUseGradient, DEFAULT_STAR_USE_GRADIENT);
        startColor = array.getColor(R.styleable.RatingBar_starStartColor, DEFAULT_STAR_START_COLOR);
        endColor = array.getColor(R.styleable.RatingBar_starEndColor, DEFAULT_STAR_END_COLOR);
        canTouch = array.getBoolean(R.styleable.RatingBar_starCanTouch, DEFAULT_STAR_CAN_TOUCH);
        pathData = array.getString(R.styleable.RatingBar_starPathData);
        pathDataId = array.getResourceId(R.styleable.RatingBar_starPathDataId, DEFAULT_STAR_PATH_DATA_ID);
        coverDir = array.getInteger(R.styleable.RatingBar_starCoverDir, CoverDir.leftToRight);
    ...
    public RatingBar setStarSize(int starSize) {
        if (starSize <= 0) {
    ...
    public RatingBar setStarCount(int starCount) {
        if (starCount <= 0) {
    ...
    public RatingBar setStarSpace(int starSpace) {
        this.starSpace = starSpace;
        reDraw(true);
        return this;
    }

    public RatingBar setStarStrokeWidth(int starStrokeWidth) {
    ...
    public RatingBar setShowStroke(boolean showStroke) {
        this.showStroke = showStroke;
        reDraw(false);
        return this;
    }

    public RatingBar setStarStrokeColor(int starStrokeColor) {
    ...
    public RatingBar setStarFillColor(int starFillColor) {
    ...
    public RatingBar setStarCoverColor(int starCoverColor) {
    ...
    public RatingBar setStarMaxProgress(float starMaxProgress) {
    ...
    public RatingBar setStarProgress(float starProgress) {
    ...
    public RatingBar setUseGradient(boolean useGradient) {
    ...
    public RatingBar setStartColor(int startColor) {
    ...
    public RatingBar setEndColor(int endColor) {
    ...
    public RatingBar setCanTouch(boolean canTouch) {
        this.canTouch = canTouch;
        return this;
    }

    public RatingBar setOnStarTouchListener(OnStarTouchListener onStarTouchListener) {
        this.onStarTouchListener = onStarTouchListener;
        return this;
    }

    public RatingBar setPath(Path mPath) {
        this.mPath = mPath;
        reDraw(false);
    ...
    public RatingBar setPathData(String pathData) {
    ...
    public RatingBar setPathDataId(int pathDataId) {
    ...
    public RatingBar setDefaultPathData() {
        return this.setPathDataId(DEFAULT_STAR_PATH_DATA_ID);
    }

    public RatingBar setCoverDir(int coverDir) {
